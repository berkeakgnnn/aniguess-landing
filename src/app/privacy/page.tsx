    ...
    <div className="min-h-screen" style={{ background: "#0d0820" }}>
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="flex flex-col gap-10">
          ...
          <PolicySection title="Product Analytics (PostHog)">
            <p>
              Starting with version 1.2.7, AniMyst uses PostHog, a product analytics
              service, to understand how the App is used: screen views and gameplay
              events such as opening a pack or finishing the daily character. These
              events are tied to an anonymous account identifier generated by the App.
              We do not send your name, email address, contacts, or precise location
              to PostHog.
            </p>
            <p>
              This data is used only to improve the App. It is not used for advertising
              and is not shared with data brokers. PostHog processes it under the{" "}
              <a
          ...
          <PolicySection title="KVKK (Turkish Users)">
            <p>
              ...
              Sürüm 1.2.7 itibarıyla uygulama kullanımına ilişkin anonim ürün analitiği
              (ekran görüntülemeleri ve oyun içi olaylar) PostHog aracılığıyla
              işlenmektedir; bu veriler ad, e-posta veya iletişim bilgisi içermez ve
